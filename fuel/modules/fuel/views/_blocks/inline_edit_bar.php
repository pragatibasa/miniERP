...
<?=js('jquery/jquery, jquery/plugins/jquery.form, jquery/plugins/jqModal, jquery/plugins/date, jquery/plugins/jquery.datePicker, jquery/plugins/jquery.tooltip, editors/ckeditor/ckeditor.js, fuel/linked_field_formatters.js, editors/markitup/jquery.markitup.pack, editors/markitup/jquery.markitup.set, jquery/plugins/jquery.serialize, jquery/plugins/jquery.cookie, jquery/plugins/jquery.supercookie, jquery/plugins/jquery.disable.text.select.pack, jquery/plugins/jquery.selso, jquery/plugins/jquery.fillin, jquery/plugins/jquery.supercomboselect, jquery/plugins/jquery.MultiFile, jquery/plugins/jquery.scrollTo-min, jquery/plugins/jquery.ba-resize.min, fuel/edit_mode', 'fuel')?>
