	   ...
	   $.ajax({
        ...
        dataType: "json"
	      ...
	      //  obj = JSON.parse(msg);
			...
			mediaClass += '<td>' + '<a title="Cutting Instruction" href="'+item.ci+'"><span class="badge badge-success" style="color: #FFFFFF;">Cutting</span></a>'+'<a title="Slitting Instruction" href="'+item.sl+'"><span class="badge badge-info" style="color: #FFFFFF;">Slitting</span></a>' + '<a title="Recoling Instruction" href="'+item.rc+'"><span class="badge badge-warning" style="color: #FFFFFF;">Recoiling</span></a>' +'<a title="Billing Instruction" href="'+item.bi+'"><span class="badge badge-important" style="color: #FFFFFF;">Billing</span></a>' + '<a title="Transfer Instruction" href="'+item.tr+'"><span class="badge" style="color: #FFFFFF;">Transfer</span></a>'+ '</td>';
